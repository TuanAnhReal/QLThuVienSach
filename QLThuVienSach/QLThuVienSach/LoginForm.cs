    ...
    public class LoginForm
    {
        ...
        public void ShowLoginMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine($"|{"1. Đăng nhập",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"2. Đăng ký",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"3. Quên mật khẩu",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"4. Thoát",-23}|");
                Console.WriteLine(new string('-', 25));
        ...
        private void ShowAdminMenu()// hiển thị menu cho Admin
        {
            while (true)
            {
                Console.Clear();
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"Menu Admin:",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"1. Quản lý sách",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"2. Quản lý khách hàng",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"3. Đăng xuất",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.Write("Chọn một tùy chọn: ");
        ...
        private void ShowUserMenu()// hiển thị menu cho KH
        {
            while (true)
            {
                Console.Clear();
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"Menu User:",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"1. Mượn sách",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"2. Trả sách",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"3. Xem thông tin cá nhân",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.WriteLine($"|{"4. Đăng xuất",-23}|");
                Console.WriteLine(new string('-', 25));
                Console.Write("Chọn một tùy chọn: ");
                if (!int.TryParse(Console.ReadLine(), out int choice))
                {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    case 1:
                        ...
                        Console.Write("Nhập địa chỉ của khách hàng: ");
                        string diachi = Console.ReadLine();
                        Users newUser = new Users(maKH, tenKH, sdt, diachi, new System.Collections.Generic.List<string>(),
